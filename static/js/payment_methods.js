...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const mortgageLoanReferenceNumber = document.getElementById(
  ...
  function validate() {
    const infoFilled = [street, city, postal, nationalId, country].every(
      isFilled
    );
    const cardFilled = [
      cardName,
    ...
    const mortgageFilled = [
      mortgageBankNumber,
      mortgageLoanReferenceNumber,
    ].every(isFilled);
