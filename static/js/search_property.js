...
document.querySelectorAll(".sort-arrow-btn").forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    const isPriceGroup =
      parentGroup.querySelector(".sort-label-order").textContent ===
      "Price Range";
    ...
    const directionBtn = parentGroup.querySelector(
      ".sort-arrow-btn:not(.sort-label-order)"
...
const sort = () => {
  const propertyElements = [
    ...document.querySelectorAll("[data-price][data-name]"),
